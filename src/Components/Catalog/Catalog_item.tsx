    ...
    switch (shareType) {
      ...
      default:
        return (
          ...
          >
            <path
              d="M12.2229 4.18354C11.9863 3.94691 11.604 3.94691 11.3674 4.18354L8.40039 7.14448L5.43338 4.17747C5.19675 3.94084 4.8145 3.94084 4.57787 4.17747C4.34123 4.41411 4.34123 4.79636 4.57787 5.03299L7.54487 8L4.57787 10.967C4.34123 11.2036 4.34123 11.5859 4.57787 11.8225C4.8145 12.0592 5.19675 12.0592 5.43338 11.8225L8.40039 8.85552L11.3674 11.8225C11.604 12.0592 11.9863 12.0592 12.2229 11.8225C12.4595 11.5859 12.4595 11.2036 12.2229 10.967L9.25591 8L12.2229 5.03299C12.4535 4.80243 12.4535 4.41411 12.2229 4.18354Z"
              fill="#F83C3C"
            />
          </svg>
        );
    ...
    >
      <div className={bigItem ? "item-big" : "item"}>
        ...
        <div className="item-information">
          {bigItem && <div className="item-information-big-title">{title}</div>}
          {!bigItem && <div className="item-information-title">{title}</div>}
          <div className="item-information-description">{description}</div>
        </div>
        {!bigItem && (
              ...
              {shareType === "discount" ? (
                <div className="item-about-chapter-block">
                  ...
                  <div className="item-about-chapter-price">
                    {price[0] - (price[0] / 100) * discounts[0]}₽
                  </div>
                </div>
              ) : (
                <div className="item-about-chapter-block">
                  <div className="item-about-chapter-price">{price[0]}₽</div>
                </div>
              )}
            </div>
          </div>
        ...
        {bigItem && (
          <div className={bigItem ? "item-big-about" : "item-about"}>
            <div
              className={
                bigItem ? "item-big-about-chapter" : "item-about-chapter"
              }
            >
              <div className="item-about-chapter-weight">Вес</div>
              <div
                className={
                  bigItem
                    ? "item-big-about-chapter-price"
                    : "item-about-chapter-price"
                }
              >
                Цена
              </div>
            ...
            {weight.map((weight, idx) => (
              <div key={weight} className="item-big-about-chapter">
                ...
                {prompt && (
                  <div className="item-big-about-chapter-prompt">
                    При покупке двух коробок сока “Сады Придонья” 2л, в подарок
                    идёт третья коробка сока
                  </div>
                )}
                <div className="item-big-about-chapter-bonus">
                  ...
                  >
                    <path
                      d="M7.99935 2.66797C12.0493 2.66797 15.3327 4.45864 15.3327 6.66797V9.33463C15.3327 11.544 12.0493 13.3346 7.99935 13.3346C4.02135 13.3346 0.783349 11.6073 0.669349 9.45263L0.666016 9.33463V6.66797C0.666016 4.45864 3.94935 2.66797 7.99935 2.66797ZM7.99935 10.668C5.51935 10.668 3.32602 9.99663 1.99935 8.96797V9.33463C1.99935 10.5893 4.58802 12.0013 7.99935 12.0013C11.3393 12.0013 13.8913 10.648 13.996 9.4133L13.9993 9.33463L14 8.96797C12.6733 9.99597 10.48 10.668 7.99935 10.668ZM7.99935 4.0013C4.58802 4.0013 1.99935 5.4133 1.99935 6.66797C1.99935 7.92264 4.58802 9.33463 7.99935 9.33463C11.4107 9.33463 13.9993 7.92264 13.9993 6.66797C13.9993 5.4133 11.4107 4.0013 7.99935 4.0013Z"
                      fill="#0D0D0D"
                    />
                  </svg>
                </div>
        ...
        {!bigItem && (
          <div className="item-more">
            <div
              className="item-more-text"
              onClick={() => setBigItem(!bigItem)}
            >
              Подробнее
            </div>
            <svg
