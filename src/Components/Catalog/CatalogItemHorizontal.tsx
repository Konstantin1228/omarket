...
import { ItemType } from '../Home/CatalogItem';
import { addItemToasts } from '../../redux/toasts/slice';
import { addToCart } from '../../redux/cart/slice';
import { Rating } from '@mui/material';
import GradeIcon from '@mui/icons-material/Grade';
import "./horizontalItem.scss"
const CatalogItem: React.FC<ItemType> = ({ id, title, description, image, tags, typeOfUnit, discounts, weight, points, price, rating }) => {
