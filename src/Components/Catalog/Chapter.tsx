...
const Chapter: React.FC<ChapterProps> = ({
  ...
  useEffect(() => {
    if (databaseName) {
      const getRes = async () => {
        await axios
          .get(`http://localhost:3001/goods?_limit=4&_page=${page}`)
          .then((res) => {
    ...
    <div className="chapter">
      <div className="chapter-top">
        ...
        <div className="chapter-top-pagination">
          ...
          >
            <path
              d="M0.553654 11.7489C0.260761 11.4142 0.260761 10.8715 0.553654 10.5368L4.52332 6L0.553654 1.46323C0.260761 1.1285 0.260761 0.585785 0.553654 0.25105C0.846547 -0.0836859 1.32142 -0.0836859 1.61431 0.25105L6.11431 5.39391C6.4072 5.72864 6.4072 6.27135 6.11431 6.60609L1.61431 11.7489C1.32142 12.0837 0.846547 12.0837 0.553654 11.7489Z"
              fill="#FF6600"
            />
          </svg>
        </div>
