...
const Cart_Item: React.FC<itemsInCart> = ({ title, count, discounts, image, points, price, tags, totalPoints, typeOfUnit, totalPrice, weight }) => {
    ...
    <div className="itemCart">
      ...
      <div className="itemCart-right">
        <div className="itemCart-right-counter">
          <div className="itemCart-right-counter-minus" onClick={() => dispatch(countMinus({ title, weight }))}>
            <svg
              width="12"
              height="2"
              viewBox="0 0 12 2"
          ...
          <div className="itemCart-right-counter-plus" onClick={() => dispatch(countPlus({ title, weight }))}>
            <svg
              width="12"
              height="12"
              viewBox="0 0 12 12"
        ...
        <div className="itemCart-right-delete" onClick={() => dispatch(deleteItem({ title, weight }))}>
          <svg
            width="14"
            height="14"
            viewBox="0 0 14 14"
